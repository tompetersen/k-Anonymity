...
\defbeamertemplate{background canvas}{titlepage}{%
	{\color{svsgrau1}\vrule width\paperwidth height0.63\paperheight}%
	{\color{white}\vrule width\paperwidth height0.37\paperheight}%
}
...
\input{content/k_anonymity.tex}

\input{content/l_diversity.tex}

\input{content/t_closeness.tex}
